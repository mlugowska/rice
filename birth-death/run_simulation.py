    ...
    if tree.tree:
        ...
        if bd.mu:
            ...
            if not bd.extinct():
                ...
                df_mu_freq.to_excel(
                    f'/Users/magdalena/PycharmProjects/rice/birth-death/results/{k}x/stats/{k_i}-N-{bd.N}-mu-freq.xlsx')
                df_sfs.to_excel(
                    f'/Users/magdalena/PycharmProjects/rice/birth-death/results/{k}x/stats/{k_i}-N-{bd.N}-sfs.xlsx')
                # import pdb; pdb.set_trace()
                histograms.sfs(df_sfs)
                plt.savefig(
                    f'/Users/magdalena/PycharmProjects/rice/birth-death/results/{k}x/plots/{k_i}-N-{bd.N}-sfs.png')

        df_cells.to_excel(
            f'/Users/magdalena/PycharmProjects/rice/birth-death/results/{k}x/stats/{k_i}-N-{bd.N}-stats.xlsx')

        histograms.cells_life_distribution(df_cells, mean_lifetime)
        plt.savefig(
            f'/Users/magdalena/PycharmProjects/rice/birth-death/results/{k}x/plots/{k_i}-N-{bd.N}-life-distribution.png')
...
plt.savefig(f'/Users/magdalena/PycharmProjects/rice/birth-death/results/{k}x/plots/mean-lifetime-distribution.png')
...
if sfs_list:
    ...
    plt.savefig(f'/Users/magdalena/PycharmProjects/rice/birth-death/results/{k}x/plots/mean-sfs.png')
...
plt.savefig(f'/Users/magdalena/PycharmProjects/rice/birth-death/results/{k}x/plots/trajectory.png')

"""
plot histogram of N frequency
"""
histograms.N_freq_in_specific_timesteps(df_N)
plt.savefig(f'/Users/magdalena/PycharmProjects/rice/birth-death/results/{k}x/plots/N-distribution.png')
# plt.show()
